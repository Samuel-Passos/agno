"""
Exemplo de fala para texto usando OpenAI. Este cookbook demonstra como transcrever arquivos de áudio usando OpenAI e obter saída estruturada.
"""
...
agent = Agent(
    ...
    # Usamos um modelo parser aqui pois gpt-audio-2025-08-28 não pode retornar saída estruturada por si só
